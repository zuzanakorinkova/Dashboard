...
const Form = (props) => {
    ...
    return (
        <Box m="20px">
            ...
            <Formik onSubmit={handleFormSubmit} initialValues={userInput} validationSchema={schema}>
                {({ handleBlur, handleSubmit}) => (
                    <form onSubmit={handleSubmit}>
                        <Box display="grid" gap="10px" mt="20px" gridTemplateColumns="repeat(4, minmax(0, 1fr))"
                        sx={{
